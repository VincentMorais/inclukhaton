...
import {companyAdminPath, contactPath, incluscoreAdminPath, inclusionConseilPath, servicesPath} from '../../../routes/publicRoutes';
					...
					<div className="collapse navbar-collapse" id={this.burgerMenuId}>
						<ul className="navbar-nav">
							...
							<ClickableLinkNavBar
								...
								label={'Contact'}
							/>
							<li className={'navbar-title1'}> 
							<ClickableLinkNavBar
								goTo={goTo}
								url={companyAdminPath}
								isActive={pathname.includes(companyAdminPath)}
								linkId={'entreprises'}
								label={'Entreprises'}
							/>
							</li>
							<li className={'navbar-title2'}> 
							<ClickableLinkNavBar
								goTo={goTo}
								url={incluscoreAdminPath}
								isActive={pathname.includes(incluscoreAdminPath)}
								linkId={'incluscores'}
								label={'Incluscores'}
							/>
							</li>
